...
var BuildingListElement = React.createClass({displayName: "BuildingListElement",
  render: function() {
    var building = this.props.item;
    var string = building.city + ' ' + building.name + ' (' + building.height +'m)';
